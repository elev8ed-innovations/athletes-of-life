...
exports.handler = async function(event) {
  ...
  const scoresSummary = scores.map((s,i) => `${dimensionNames[i]}: ${s}/10`).join(', ');
...
Use their name. Use "${venue}" not "court". No fluff.`;
  ...
  const dimRows = scores.map((s,i) => `<tr><td style="padding:8px 0;color:#777;font-size:13px;border-bottom:1px solid #1a1a1a;">${dimensionNames[i]}</td><td style="padding:8px 0;font-size:13px;text-align:right;border-bottom:1px solid #1a1a1a;color:#C9A84C;">${s}/10</td></tr>`).join('');
  const auditParas = auditText.split('\n\n').map(p => `<p style="margin-bottom:14px;color:#ccc;font-size:15px;line-height:1.75;">${p.trim()}</p>`).join('');

  await Promise.all([
    resend.emails.send({ from: FROM_EMAIL, to: email, subject: `${name}, welcome to Athletes of Life — your audit is inside`, html: `<div style="background:#0A0A0A;color:#F5F5F0;font-family:Arial,sans-serif;max-width:600px;margin:0 auto;padding:40px 32px;"><div style="font-size:22px;font-weight:900;color:#C9A84C;letter-spacing:.08em;margin-bottom:28px;">ATHLETES OF LIFE</div><h1 style="font-size:26px;font-weight:700;margin-bottom:16px;">Glad you are here, ${name}.</h1><p style="color:#aaa;font-size:15px;line-height:1.75;margin-bottom:20px;">I am Anthony Lever. 15 years as a pro basketball player around the world. Son of NBA All-Star Lafayette "Fat" Lever. I built Athletes of Life because when my career ended, nobody handed me a playbook. I built this so you do not have to figure it out alone.</p><div style="background:#111;border:1px solid #222;border-radius:16px;padding:32px;text-align:center;margin-bottom:28px;"><div style="font-size:11px;letter-spacing:.16em;text-transform:uppercase;color:#C9A84C;margin-bottom:12px;">${readinessLabel}</div><div style="font-size:64px;font-weight:900;color:#C9A84C;line-height:1;">${totalScore}</div><div style="font-size:18px;color:#444;">/ 50</div><div style="font-size:14px;color:#777;margin-top:8px;">Business Readiness Score</div></div><div style="background:#0f0f0f;border:1px solid #222;border-radius:12px;padding:24px;margin-bottom:24px;"><div style="font-size:11px;letter-spacing:.14em;text-transform:uppercase;color:#C9A84C;margin-bottom:16px;">Your Personalized Audit</div>${auditParas}</div><div style="background:#0f0f0f;border:1px solid #222;border-radius:12px;padding:24px;margin-bottom:24px;"><div style="font-size:11px;letter-spacing:.14em;text-transform:uppercase;color:#C9A84C;margin-bottom:12px;">Dimension Scores</div><table style="width:100%;border-collapse:collapse;">${dimRows}</table></div><div style="background:linear-gradient(135deg,#141209,#0f0f0f);border:1px solid rgba(201,168,76,0.25);border-radius:12px;padding:24px;margin-bottom:28px;"><div style="font-size:11px;letter-spacing:.14em;text-transform:uppercase;color:#C9A84C;margin-bottom:8px;">Your Recommended Track</div><div style="font-size:24px;font-weight:900;">${bestTrack}</div></div><a href="${CAL_LINK}" style="display:block;background:#C9A84C;color:#000;font-weight:700;font-size:15px;padding:16px 28px;border-radius:8px;text-decoration:none;margin-bottom:28px;text-align:center;">Book a Free Strategy Call with Anthony</a><p style="color:#777;font-size:13px;border-top:1px solid #1a1a1a;padding-top:20px;">— Anthony Lever<br><span style="color:#555;">Founder, Athletes of Life · <div style=\"margin-bottom:28px;\"><div style=\"font-size:11px;letter-spacing:.14em;text-transform:uppercase;color:#C9A84C;margin-bottom:16px;\">YOUR THREE-TIER PATH</div><table style=\"width:100%;border-collapse:collapse;\"><tr><td style=\"background:#111;border:1px solid #222;border-radius:10px;padding:16px 20px;\"><div style=\"font-size:10px;letter-spacing:.12em;text-transform:uppercase;color:#555;margin-bottom:4px;\">TIER 1</div><div style=\"font-size:16px;font-weight:700;margin-bottom:4px;\">Foundation</div><div style=\"font-size:18px;font-weight:900;color:#C9A84C;margin-bottom:8px;\">FREE</div><div style=\"font-size:12px;color:#777;line-height:1.5;\">Skool community, core frameworks, weekly Q&amp;A. Start here.</div></td></tr><tr><td style=\"padding:4px;\"></td></tr><tr><td style=\"background:#141209;border:1px solid rgba(201,168,76,0.4);border-radius:10px;padding:16px 20px;\"><div style=\"font-size:10px;letter-spacing:.12em;text-transform:uppercase;color:#C9A84C;margin-bottom:4px;\">TIER 2 — RECOMMENDED</div><div style=\"font-size:16px;font-weight:700;margin-bottom:4px;\">Pro Playbook</div><div style=\"font-size:18px;font-weight:900;color:#C9A84C;margin-bottom:8px;\">$97/mo</div><div style=\"font-size:12px;color:#777;line-height:1.5;\">Live Zoom sessions, expert network, track-specific playbook.</div></td></tr><tr><td style=\"padding:4px;\"></td></tr><tr><td style=\"background:#111;border:1px solid #222;border-radius:10px;padding:16px 20px;\"><div style=\"font-size:10px;letter-spacing:.12em;text-transform:uppercase;color:#555;margin-bottom:4px;\">TIER 3</div><div style=\"font-size:16px;font-weight:700;margin-bottom:4px;\">Platinum Execution</div><div style=\"font-size:18px;font-weight:900;color:#C9A84C;margin-bottom:8px;\">$5,000+</div><div style=\"font-size:12px;color:#777;line-height:1.5;\">Done-for-you AI automation, NIL pipeline, 1-on-1 with Anthony.</div></td></tr></table></div>Elev8ed Innovation LLC</span></p></div>` }),
